...
entry:
  call void (...) @__enzyme_fwddiff(void (double*, i64*, double*)* @f, metadata !"enzyme_dup", double* %A, double* %dA, metadata !"enzyme_const", i64* %ipiv, metadata !"enzyme_dup", double* %B, double* %dB)
  ret void
}
